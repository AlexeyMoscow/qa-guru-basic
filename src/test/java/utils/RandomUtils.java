...
public class RandomUtils {
    ...
    static String firstName, lastName, userEmail, streetAddress, userGender, userMobileNumber, userBirthYear,
            userBirthMonth, userBirthDay, userSubject, userHobby, userPicture, userState, userCity;
    ...
    public static String getHobby() {
        return userHobby = faker.options().option("Sports", "Reading", "Music");
    }

    public static String getPicture() {
        return userPicture = faker.options().option("feelLikeLord.jpeg", "feelLikeSir.jpeg");
    }
